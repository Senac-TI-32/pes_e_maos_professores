    ...
    document.getElementById("navbar").innerHTML = `
            ...
            <ul class="nav-primaria">
               ...
               <ul class="navegacao">
                    ...
                    <li>
                        <a href="index.html#relatos">Relatos</a>
                    </li>
                    <li>
